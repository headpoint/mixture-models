...
![Optional Text](../misc/plot.png)


![Cat](https://raw.githubusercontent.com/headpoint/master/misc/plot.png)

![Contours using the fitted mixture model parameters.](https://github.com/headpoint/misc/master/plot.png)
